...
const std::unordered_map<OpCodeId, OpCode> opCodeTable = {
    ...
    {OpCodeId::MOV, OpCode{0x72, 2}},     {OpCodeId::JE, OpCode{0x73, 2}},     {OpCodeId::JNE, OpCode{0x74, 2}},
    ...
    {OpCodeId::TRAP, OpCode{0x7692, 0}},  {OpCodeId::SWM, OpCode{0x7693, 0}},  {OpCodeId::JMP, OpCode{0x7694, 0}}};
...
const std::unordered_map<OpCodeId, uint8_t> opCodeDereferenceMap = {
    ...
    {OpCodeId::JNZ, 0b00},    {OpCodeId::MOV, 0b00},    {OpCodeId::JE, 0b00},     {OpCodeId::JNE, 0b00},
    ...
    {OpCodeId::INC_M, 0b1},   {OpCodeId::DEC_M, 0b1},   {OpCodeId::STOP, 0b0},    {OpCodeId::JMP, 0b0}};
...
const std::unordered_map<uint16_t, OpCodeId> opCodeValuesTable = {
    ...
    {0x71, OpCodeId::JNZ},     {0x72, OpCodeId::MOV},     {0x73, OpCodeId::JE},      {0x74, OpCodeId::JNE},
    ...
    {0x962, OpCodeId::INC_M},  {0x964, OpCodeId::DEC_M},  {0x7692, OpCodeId::TRAP},  {0x7693, OpCodeId::SWM},
    {0x7694, OpCodeId::JMP}};

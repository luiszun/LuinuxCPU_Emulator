...
TEST(TestAssemblerSuite, TestGoto)
{
    ...
    std::vector<uint8_t> expectedBinary{
        0x76, 0x25, 0x01, 0x00, 0x76, 0x26, 0x00, 0x01, 0x45, 0x67, 0x76, 0x25, 0x00, 0x0e};
...
TEST(TestAssemblerSuite, TestAddressTags)
{
    ...
    std::vector<uint8_t> expectedBinary{0x76, 0x25, 0x00, 0x0a, 0x76, 0x2f, 0x00, 0x00,
                                        0x76, 0x27, 0x00, 0x0c, 0x76, 0x8f, 0x15, 0xf6,
                                        0x71, 0x67, 0x76, 0x91, 0x76, 0x25, 0x00, 0x10};
